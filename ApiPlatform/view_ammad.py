...
#     api_url = f"{settings.BASE_API_URL}/games/get-all-games/"
...
#                 "game_image": game.get('game_image', 'default_image_url'),
#                 "game_description": game.get('game_description', 'No description available.'),
#                 "game_created_at": game.get('game_created_at', 'N/A'),
#                 "total_players": game.get('total_players', 0),
#                 "players": game.get('players', []),
#                 "reviews": game.get('reviews', [])
#             }
#         all_games.append(all_game)
#     else:
#         all_games = []
#
#     return render(request, 'partials/all-games.html', {"all_games": all_games})
##
...
@api_view(['GET'])
# @permission_classes([AllowAnyWithAuthCheck])
# @permission_classes([IsAuthenticated])
