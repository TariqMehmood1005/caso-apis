...
class GameVaultPanel(object):
    """Unofficial API wrapper for the Game Vault panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://agent.gamevault999.com/login"
    __LANDING_PAGE: str = "https://agent.gamevault999.com/userManagement"
    __PANEL_SCORE_API: str = "https://agent.gamevault999.com/api/agent/balance"
    __ADD_PLAYER_API: str = "https://agent.gamevault999.com/api/user/addUser"
    __USER_SCORE_API: str = "https://agent.gamevault999.com/api/user/userList"
    __ADD_SCORE_API: str = "https://agent.gamevault999.com/api/user/rechargeRedeem"
    __REDEEM_SCORE_API: str = "https://agent.gamevault999.com/api/user/rechargeRedeem"
    __RESET_PASSWORD_API: str = "https://agent.gamevault999.com/api/user/resetUserPwd"

    def __init__(
            self,
            headless: bool = True,
            storage_state_path: str = "PanelsHandler/PanelMemoryFiles/game_vault_storage.json",
            ...
            timeout: int = 10000,
            num_browsers: int = 2,
            logs_file: str = "PanelsHandler/PanelLogs/game_vault_logs.log",
