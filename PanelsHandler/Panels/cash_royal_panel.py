...
class CashRoyalPanel(object):
    """Unofficial API wrapper for the Cash Royal panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://agent.casinoroyale07.com/login"
    __LANDING_PAGE: str = "https://agent.casinoroyale07.com/userManagement"
    __PANEL_SCORE_API: str = "https://agent.casinoroyale07.com/api/agent/balance"
    __ADD_PLAYER_API: str = "https://agent.casinoroyale07.com/api/user/addUser"
    __USER_SCORE_API: str = "https://agent.casinoroyale07.com/api/user/userList"
    __ADD_SCORE_API: str = "https://agent.casinoroyale07.com/api/user/rechargeRedeem"
    __REDEEM_SCORE_API: str = "https://agent.casinoroyale07.com/api/user/rechargeRedeem"
    __RESET_PASSWORD_API: str = "https://agent.casinoroyale07.com/api/user/resetUserPwd"

    def __init__(
            self,
            headless: bool = True,
            storage_state_path: str = "PanelsHandler/PanelMemoryFiles/cash_royal_storage.json",
            ...
            timeout: int = 10000,
            num_browsers: int = 2,
            logs_file: str = "PanelsHandler/PanelLogs/cash_royal_logs.log",
    ...
    async def initialize_panel(self):
        ...
        if not await self.browser_pool.game_vault_related_session():
            await self.__logger.logs(
                message="ERROR: Cash Royal session does not created.",
