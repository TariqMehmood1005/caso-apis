...
class EGamePanel(object):
    """Unofficial API wrapper for the EGame panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://pko.egame99.club/#/login"
    __LANDING_PAGE: str = "https://pko.egame99.club/#/index"
    __ACCOUNT_PAGE: str = "https://pko.egame99.club/#/manage-user/account"
    __SCORE_PAGE: str = "https://pko.egame99.club/#/manage-user/search"

    def __init__(
            self,
            headless: bool = True,
            storage_state_path: str = "PanelsHandler/PanelMemoryFiles/e_game_storage.json",
