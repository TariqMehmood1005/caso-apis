...
class VBlinkPanel(object):
    """Unofficial API wrapper for the VBlink panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://gm.vblink777.club/#/login"
    __LANDING_PAGE: str = "https://gm.vblink777.club/#/index"
    __ACCOUNT_PAGE: str = "https://gm.vblink777.club/#/manage-user/account"
    __SCORE_PAGE: str = "https://gm.vblink777.club/#/manage-user/search"
    ...
    def __init__(
            ...
            enable_js: bool = True,
            logs_file: str = "PanelsHandler/PanelLogs/v_blink_logs.log",
