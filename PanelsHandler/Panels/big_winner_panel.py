...
class BigWinnerPanel(object):
    """Unofficial API wrapper for the Big Winner panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://agent.bigwplay.com/admin/auth/login"
    __LANDING_PAGE: str = "https://agent.bigwplay.com/admin"
    __PANEL_SCORE_API: str = "https://agent.bigwplay.com/admin/refresh_score"
    __ADD_PLAYER_API: str = "https://agent.bigwplay.com/admin/player_list"
    __USER_SCORE_API: str = "https://agent.bigwplay.com/admin/player_list"
    __ADD_SCORE_API: str = "https://agent.bigwplay.com/admin/dcat-api/form"
    __REDEEM_SCORE_API: str = "https://agent.bigwplay.com/admin/dcat-api/form"
    __RESET_PASSWORD_API: str = "https://agent.bigwplay.com/admin/dcat-api/form"

    def __init__(
            self,
            headless: bool = True,
            storage_state_path: str = "PanelsHandler/PanelMemoryFiles/big_winner_storage.json",
            trained_captcha_solver_model_path: str = "PanelsHandler/TrainedModels/captcha_solver_agent_yolo_0.1.keras",
            logs_file: str = "PanelsHandler/PanelLogs/big_winner_logs.log",
    ...
    async def initialize_panel(self):
        ...
        if not await self.browser_pool.agent_yolo_related_session(no_captcha=True):
    ...
    async def _scheduler_async(self):
        ...
        while not self.stop_scheduler:
            ...
            if self.stop_scheduler:
                break
            try:
                await self.browser_pool.agent_yolo_related_session(no_captcha=True)
