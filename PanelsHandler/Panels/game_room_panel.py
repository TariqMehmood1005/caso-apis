...
class GameRoomPanel(object):
    """Unofficial API wrapper for the Game Room panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://agentserver1.gameroom777.com/admin/login"
    __LANDING_PAGE: str = "https://agentserver1.gameroom777.com/admin"
    __PANEL_SCORE_API: str = "https://agentserver1.gameroom777.com/api/agent/getMoney"
    __ADD_PLAYER_API: str = "https://agentserver1.gameroom777.com/api/player/playerInsert"
    __USER_SCORE_API: str = "https://agentserver1.gameroom777.com/api/player/userList"
    __ADD_SCORE_API: str = "https://agentserver1.gameroom777.com/api/player/agentRecharge"
    __REDEEM_SCORE_API: str = "https://agentserver1.gameroom777.com/api/player/agentWithdraw"
    __RESET_PASSWORD_API: str = "https://agentserver1.gameroom777.com/api/player/reset"

    def __init__(
            self,
            headless: bool = True,
            storage_state_path: str = "PanelsHandler/PanelMemoryFiles/game_room_storage.json",
            ...
            enable_js: bool = True,
            logs_file: str = "PanelsHandler/PanelLogs/game_room_logs.log",
                    ...
                    for user in json_data['data']:
                        if user['Account'] == username:
                            ...
                            if current_user_balance >= score:
                                payloads = {
                                    "id": user_id,
                                    "customer_balance": current_user_balance,
                                    "opera_type": "1",
                                    "balance": score,
                                    'remark': ''
                                }
