...
class PandaMasterPanel(object):
    """Unofficial API wrapper for the Panda Master panel handles the API calls and responses"""
    __LOGIN_URL: str = "https://pandamaster.vip/"
    __LANDING_PAGE: str = "https://pandamaster.vip/Store.aspx"

    def __init__(
            self,
            headless: bool = True,
            storage_state_path: str = "PanelsHandler/PanelMemoryFiles/panda_master_storage.json",
            ...
            enable_js: bool = True,
            logs_file: str = "PanelsHandler/PanelLogs/panda_master_logs.log",
